...
export const POST: AsyncRouteHandler<ReturnType<typeof createStartKnowledgeUploadItemHandler>> = createStartKnowledgeUploadItemHandler(defaultKnowledgeUploadHandlerDeps);
