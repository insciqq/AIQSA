...
import { createArtifactPublicationReissueHandler } from "@/lib/server/artifacts/handlers";
...
const handler = createArtifactPublicationReissueHandler(deps);
export const POST: AsyncRouteHandler<typeof handler> = handler;
