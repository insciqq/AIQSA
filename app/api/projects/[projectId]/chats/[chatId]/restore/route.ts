...
export const POST: AsyncRouteHandler<ReturnType<typeof createProjectChatArchiveHandler>> = createProjectChatArchiveHandler(defaultProjectContentHandlerDeps, false);
