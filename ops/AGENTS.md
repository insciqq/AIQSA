...
Root `AGENTS.md` and `agent_docs/CRITICAL_INVARIANTS.md` remain authoritative. Read `ARCHITECTURE.md`, `ENV_VARIABLES.md`, `SECURITY.md`, and the exposed-deployment lane in `TESTING.md` before changes.
