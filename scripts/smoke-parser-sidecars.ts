...
async function availableSmoke(): Promise<void> {
  ...
  try {
    ...
    const fixtures = [
      ...
      {
        bytes: gunzipSync(Buffer.from(BINARY_DOC_GZIP_BASE64, "base64")),
