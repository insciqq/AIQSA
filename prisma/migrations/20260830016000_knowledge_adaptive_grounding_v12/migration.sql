-- V12/V8 keeps the normal two-operation Draft/Selector fast path and allows
-- one bounded supplement/final-Selector pair only after accepted partial
-- coverage. Older accepted pairs remain available for exact recovery.
