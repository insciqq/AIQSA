-- Retained benchmark installations may already contain legacy Evidence V58.
-- Keep those receipts valid while adopting this previously unapplied migration.
-- Evidence V56 distinguishes Snapshot V40's fail-closed final-Selector
-- fallback while retaining V55's content-free receipt shape.
