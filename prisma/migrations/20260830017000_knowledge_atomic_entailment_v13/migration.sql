-- V13/V9 adds an atomic-entailment boundary to Draft/Selector while retaining
-- every historical purpose for exact recovery. The adaptive operation shape is
-- unchanged from V12/V8.
