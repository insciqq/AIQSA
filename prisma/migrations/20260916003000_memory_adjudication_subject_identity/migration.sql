-- Accept explicit subject-identity adjudication while retaining settled v1
-- results and previous-release writers. Match the existing eight-candidate
-- extraction bound. Other result, owner, source and settlement guards remain.
-- Explicit equivalence retains its independent closed result constraint.
