-- Draft V11 leaves only semantic claim text and evidence hints on the model
-- boundary. Prompt-local claim IDs and rendering layout are assigned by the
-- server after validation. V10/V7 and all older accepted pairs remain
-- available for exact recovery.
