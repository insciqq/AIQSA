-- Snapshot V42 introduces immutable contribution selection, additive correction
...
-- Evidence V58 binds the final publication plan and its actual aggregate counts.
