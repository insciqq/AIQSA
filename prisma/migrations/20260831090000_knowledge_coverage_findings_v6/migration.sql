-- V21 Scope V6 emits bounded positive findings per evidence unit. Every accepted
-- finding is materialized losslessly as a final dimension; Selector V21 remains
-- the independent factual-support and coverage authority.
...
CREATE UNIQUE INDEX "KnowledgeProviderAttempt_v21_scope_v6_request_key"
  ON "KnowledgeProviderAttempt" ("modelRunId", "purpose", "requestHash")
  WHERE "purpose" = 'knowledge_coverage_scope_v6';

CREATE UNIQUE INDEX "KnowledgeProviderAttempt_v21_selector_v21_request_key"
  ON "KnowledgeProviderAttempt" ("modelRunId", "purpose", "requestHash")
  WHERE "purpose" = 'knowledge_grounded_selector_v21';
...
ALTER TABLE "KnowledgeGroundingResult"
  ADD CONSTRAINT "KnowledgeGroundingResult_evidence_version_check" CHECK (
    ...
    OR "version" IN (7, 8, 9, 10, 11, 12, 14, 15, 16, 17, 18, 19, 20, 21, 22)
