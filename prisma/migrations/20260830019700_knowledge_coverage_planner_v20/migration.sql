-- Coverage Planner V20 is a distinct durable operation before Draft V20 and
-- Selector V16. Historical operation pairs remain valid for exact recovery;
-- new runs write content-free Grounding Evidence V16.
...
ALTER TABLE "KnowledgeGroundingResult"
  ADD CONSTRAINT "KnowledgeGroundingResult_evidence_version_check" CHECK (
    ...
    OR "version" IN (7, 8, 9, 10, 11, 12, 14, 15, 16)
