-- V21 Scope V4 requires an exhaustive deterministic evidence-atom review
-- before query-to-evidence reduction. Selector V19 consumes the immutable
-- atom-derived scope, and grounding evidence V20 attests the new protocol.
...
ALTER TABLE "KnowledgeProviderAttempt"
  ADD CONSTRAINT "KnowledgeProviderAttempt_contract_check" CHECK (
    ...
    AND (
      ...
      OR "purpose" ~ '^knowledge_coverage_scope_v[34]$'
      ...
      OR "purpose" ~ '^knowledge_grounded_selector(?:_final)?_v(?:[89]|1[0-9])$'
    )
...
CREATE UNIQUE INDEX "KnowledgeProviderAttempt_v21_scope_v4_request_key"
  ON "KnowledgeProviderAttempt" ("modelRunId", "purpose", "requestHash")
  WHERE "purpose" = 'knowledge_coverage_scope_v4';

CREATE UNIQUE INDEX "KnowledgeProviderAttempt_v21_selector_v19_request_key"
  ON "KnowledgeProviderAttempt" ("modelRunId", "purpose", "requestHash")
  WHERE "purpose" = 'knowledge_grounded_selector_v19';
...
ALTER TABLE "KnowledgeGroundingResult"
  ADD CONSTRAINT "KnowledgeGroundingResult_evidence_version_check" CHECK (
    ...
    OR "version" IN (7, 8, 9, 10, 11, 12, 14, 15, 16, 17, 18, 19, 20)
