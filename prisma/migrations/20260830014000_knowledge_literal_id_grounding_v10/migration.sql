-- Selector V7 chooses deterministic server-authored literal span IDs instead
-- of regenerating exact quote strings. Draft V10 preserves Draft V9 semantics
-- while giving the incompatible V10/V7 pair an unambiguous recovery identity.
-- V9/V6, V8/V6, and V7/V5 remain accepted for exact recovery.
