-- V14/V10 adds an explicit, private required-dimension coverage map while
-- retaining every historical purpose for exact recovery. Provider call count
-- and the bounded adaptive operation shape are unchanged.
