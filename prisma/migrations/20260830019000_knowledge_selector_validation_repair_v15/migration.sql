-- V15/V11 adds one bounded Selector validation-repair operation over the
-- immutable primary Draft and evidence. It retains every historical purpose
-- for exact recovery and records the mutually exclusive repair/correction
-- operation shape in Grounding Evidence V11.
