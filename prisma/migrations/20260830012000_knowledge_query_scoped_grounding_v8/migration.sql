-- V8/V6 scopes completeness to the user's requested answer dimensions. An
-- explicitly exhaustive request still requires every material item, while a
-- broad overview uses supported mechanisms and representative evidence.
-- V7/V5 remains accepted for exact recovery; new runs mint only V8/V6.
