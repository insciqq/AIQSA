-- Draft V9 preserves distinct evidence-backed condition-to-outcome mappings
-- before Selector V6 performs its existing query-scoped precision judgment.
-- V8/V6 and V7/V5 remain accepted for exact recovery; new runs mint V9/V6.
