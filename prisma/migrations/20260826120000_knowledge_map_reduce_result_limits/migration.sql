-- Broad answer-model retrieval maps the admitted corpus with up to sixteen
-- primary results. A follow-up narrowed to disclosed Source aliases reduces
-- that evidence with the original eight-result precision bound. Historical
-- focused and query-only receipts remain transition-compatible at eight.
