...
export function AdminRolesSection({
  ...
  useEffect(() => {
    ...
    const id = ({ system: "system", memory: "memory", chat_pdf: "chat-pdf", vision: "vision", chat_titles: "chat-titles", reranker: "reranker", decisions: "decisions" } as Record<string, string>)[resource];
