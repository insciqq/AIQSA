...
export function AdminProviderCredentialsTask({
  ...
  return (
    <section className="min-w-0" data-testid="provider-task-credentials">
      <div className="flex flex-col gap-3 border-b border-trace-subtle px-4 py-5 sm:flex-row sm:items-start sm:justify-between sm:px-6">
      ...
      {addOpen ? (
        <form
          className="grid gap-3 border-b border-trace-subtle bg-control-surface/55 px-4 py-4 md:grid-cols-[minmax(10rem,.35fr)_minmax(14rem,1fr)_auto] md:items-end sm:px-6"
          onSubmit={(event) => {
            ...
            const publicationTone = presentation.publication === "active"
              ...
              : presentation.publication === "revoked"
                ...
                : presentation.publication === "draft" || presentation.publication === "replacement"
                  ...
                  : "neutral";
            return (
              <div className="px-4 py-4 sm:px-6" key={credential.id} role="listitem">
