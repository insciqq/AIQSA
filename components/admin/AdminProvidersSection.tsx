                ...
                <button
                  ...
                  onClick={() => requestConfirmation({
                    body: connection.family === "openai_compatible"
                      ? "AIQSA will remove this custom connection, its models, encrypted credentials, assignments, model grants, personal, chat, or installation model defaults, and the system model role when they point to its deployments. Active or recoverable runs, Assistant revisions, and model-backed Search strategies still block deletion so history and automation stay valid."
                      : "The connection can be deleted only after child credentials, models, grants, defaults, the system model role, Assistant revisions, Search references, and live run bindings are removed.",
