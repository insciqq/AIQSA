...
export function AdminPanel({ adminEmail, adminUserId }: AdminPanelProps) {
  ...
  return (
    <main
      aria-busy={isBusy}
      className="min-h-[100dvh] overflow-x-clip bg-app-canvas pb-[env(safe-area-inset-bottom)] pl-[env(safe-area-inset-left)] pr-[env(safe-area-inset-right)] pt-[env(safe-area-inset-top)] text-ink"
    >
      <div
