      ...
      {open ? (
        ...
        >
          <div className="mb-2 flex items-start justify-between gap-3">
            ...
            <button aria-label="Close Search picker" className="grid size-11 shrink-0 place-items-center rounded-control text-ink-muted hover:bg-control-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus sm:size-8 [@media(hover:none)]:!size-11 [@media(pointer:coarse)]:!size-11" onClick={() => setOpen(false)} type="button"><X aria-hidden="true" className="size-4" /></button>
          </div>
