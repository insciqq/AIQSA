...
const COPY = {
  ...
  RU: {
    advanced: "Расширенные сведения",
    advancedAttempts: "Попытки очистки",
    advancedError: "Последний код ошибки",
    advancedFenced: "Стал недоступен",
    advancedLastAudit: "Последняя проверка",
    advancedReference: "Идентификатор удаления",
    advancedUpdated: "Обновлено",
    archiveAction: "Вместо этого архивировать",
    blocked: "Очистке требуется внимание администратора. Чат остаётся недоступным.",
    cancel: "Отмена",
    close: "Закрыть",
    confirmBody: "Чат исчезнет сразу, и восстановить его будет нельзя.",
    confirmLabel: "Удалить навсегда",
    confirmTitle: "Удалить этот чат навсегда?",
    disclosureBackups: "В резервных копиях оператора старая версия может сохраняться до обычной ротации или сверки.",
    disclosureCrossChat: "Уже принятые ответы в других чатах сохранят зафиксированные свидетельства, но источник будет помечен как удалённый и не откроется.",
    disclosureProvider: "Данные, уже отправленные AI-провайдеру или внешнему инструменту, этим действием не стираются: действует их политика хранения.",
    forgetHelp: "Дополнительно будут забыты явно сохранённые воспоминания, основанные на этом чате. Остальные сохранённые воспоминания не изменятся.",
    forgetLabel: "Также забыть сохранённые воспоминания из этого чата",
    noticeAction: "Посмотреть прогресс",
    noticeBlocked: "Чат удалён · очистке требуется внимание",
    noticePending: "Чат удалён · завершается очистка",
    noticeSucceeded: "Удаление чата завершено",
    refresh: "Обновить статус",
    refreshing: "Обновляем…",
    retryWait: "Чат недоступен. Очистка повторится автоматически.",
    stale: "Чат изменился. Проверьте обновлённые сведения и подтвердите ещё раз.",
    statePending: "Чат недоступен. Очистка поставлена в фоновую очередь.",
    stateRunning: "Чат недоступен. Идёт очистка приватных данных.",
    stateSucceeded: "Чат и принадлежащие ему данные удалены.",
    statusBody: "Пока очистка продолжается, AIQSA можно использовать как обычно.",
    statusTitle: "Безвозвратное удаление",
    unavailable: "Безвозвратное удаление пока недоступно.",
    unknownError: "Не удалось удалить чат. Ничего не удалено — попробуйте ещё раз."
  }
} as const;
