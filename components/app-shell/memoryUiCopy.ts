const EN = {
  ...
  "settings.confirmationError": "Current Memory settings could not be confirmed. Reload them before making another change.",
  ...
  "settings.resetError": "The reset could not be confirmed. Reload Memory settings to check its status before trying again.",
  ...
  "manager.mutationError": "The Memory action could not be confirmed. Check your saved memories before trying again.",
  "manager.unavailable": "Memory is temporarily unavailable. Check your saved memories when it is available again.",
  ...
  "action.mutationError": "The change could not be confirmed. Check saved memories in Memory before trying again.",
  ...
  "source.actionError": "The Memory action could not be confirmed. Check saved memories in Memory before trying again.",
  "source.openError": "The source could not be opened. Try again when it is available.",
  ...
  "source.pastChatsHeading": "Past chats · {count}",
  "source.showAll": "Show all {count}",
  "source.showLess": "Show less",
  "source.excerpts": "Excerpts · {count}",
  "source.details": "Details",
  "source.actions": "Memory actions",
  "library.description": "What AIQSA remembers about you between chats. Everything here is yours: edit it, forget it, or turn Memory off.",
