const EN = {
  ...
  "action.mutationError": "The change could not be confirmed. Check saved memories in Library before trying again.",
  ...
  "source.actionError": "The Memory action could not be confirmed. Check saved memories in Library before trying again.",
