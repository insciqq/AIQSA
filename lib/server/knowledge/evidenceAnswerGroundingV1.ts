...
export type KnowledgeGroundingEvidenceV59 = Readonly<{
  version: 59;
...
export type KnowledgeGroundingEvidenceV60 = Omit<KnowledgeGroundingEvidenceV59, "version" | "contracts"> & Readonly<{
  version: 60;
...
export function groundSettledKnowledgeEvidenceAnswerV1(input: Readonly<{
...
}>): KnowledgeGroundingEvidenceV59 | KnowledgeGroundingEvidenceV60 {
  ...
  const protocol = reviewV2 ? { version: 60 as const, contracts: KNOWLEDGE_EVIDENCE_ANSWER_CONTRACTS_V2 }
    : { version: 59 as const, contracts: KNOWLEDGE_EVIDENCE_ANSWER_CONTRACTS_V1 };
