...
export const KNOWLEDGE_ANSWER_OPERATION_SNAPSHOT_CURRENT_VERSION_V21 = 42 as const;
...
export function isRecoverableKnowledgeAnswerOperationSnapshotV21(
  ...
  KnowledgeAnswerOperationRequestSnapshotV21V39 |
  KnowledgeAnswerOperationRequestSnapshotV21V40 |
  KnowledgeAnswerOperationRequestSnapshotV21V41 | KnowledgeAnswerOperationRequestSnapshotV40 {
...
export function decodeKnowledgeAnswerOperationRequestSnapshotV21(
  ...
  if (record(value) && (value.version === 42 ||
    value.version === 40 && value.pipeline === KNOWLEDGE_ANSWER_CONTRIBUTION_PROTOCOL_V1)) {
    return decodeKnowledgeAnswerOperationRequestSnapshotV40(value);
  }
...
export function decodeKnowledgeAnswerDraftPrimaryPromptV21(input: Readonly<{
  ...
  if (input.snapshot.version === 42) return decodeKnowledgeAnswerDraftPrimaryPromptV40({
