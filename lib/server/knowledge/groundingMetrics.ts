...
export function aggregateKnowledgeGroundingMetrics(
  ...
  for (const evidence of evidences) {
    ...
    totalCrossTargetExactRepeatCount += evidence.version === 54
    ...
    totalScopeClosureReopenedDimensions += evidence.version === 34 ||
      ...
      evidence.version === 53 || evidence.version === 54
...
function metricsEvidence(value: unknown): value is KnowledgeGroundingMetricsEvidence {
  if (!record(value) || value.version !== 18 && value.version !== 19 &&
    ...
    value.version !== 53 && value.version !== 54 ||
  ...
  if (value.version === 54 && (!counter(value.crossTargetExactRepeatCount) ||
...
/** Loads V18-V54 content-free receipts; malformed rows are ignored. */
