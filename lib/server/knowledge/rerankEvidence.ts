...
export function decodeKnowledgeRerankerBindingEvidenceV2(
  ...
  if (
    ...
    value.rankingProfileVersion !== 4 && value.rankingProfileVersion !== 5 && value.rankingProfileVersion !== 6 && value.rankingProfileVersion !== 7 && value.rankingProfileVersion !== 8 && value.rankingProfileVersion !== 9 && value.rankingProfileVersion !== 10 && value.rankingProfileVersion !== 11 && value.rankingProfileVersion !== 12 ||
