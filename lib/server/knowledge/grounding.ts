...
export const KNOWLEDGE_GROUNDING_EVIDENCE_VERSION_V58 = 58 as const;
...
export type KnowledgeGroundingOperationEvidenceV58 = Omit<KnowledgeGroundingOperationEvidenceV55, "contractVersion" | "purpose"> & Readonly<{
  contractVersion: KnowledgeAnswerOperationRequestSnapshotV40["contractVersion"];
  purpose: KnowledgeAnswerOperationV40;
}>;
export type KnowledgeGroundingEvidenceV58 = Omit<KnowledgeGroundingEvidenceV55,
  ...
  operations: readonly KnowledgeGroundingOperationEvidenceV58[];
  publicationPlanHash: string;
  version: typeof KNOWLEDGE_GROUNDING_EVIDENCE_VERSION_V58;
}>;
...
export type KnowledgeGroundingResult =
  ...
  | KnowledgeGroundingEvidenceV59
  | KnowledgeGroundingEvidenceV60;
...
/** Snapshot V42 publication receipt. Contribution coverage is measured from
...
export function groundSettledKnowledgeAnswerV58(input: Readonly<{
  answerBindingFingerprint: string;
  evidence: KnowledgeEvidencePackage;
  evidenceReceiptHash: string;
  executionPolicy: KnowledgeGroundingEffectiveExecutionPolicyV1;
  ...
  const purposeForRole: Record<KnowledgeGroundingOperationEvidenceV58["role"], KnowledgeAnswerOperationV40> = {
  ...
  return Object.freeze({
    ...
    supportedClaimCount: input.settlement.supportedClaimCount,
    unsupportedClaimCount: input.settlement.unsupportedClaimCount,
    version: KNOWLEDGE_GROUNDING_EVIDENCE_VERSION_V58
  });
}
