...
const toolOperationFields = {
  ...
  operation_stage: enumeration("retrieval", "embedding", "rerank", "relevance", "draft", "selector", "auditor", "supplement", "compose", "verify")
};
...
const catalog = Object.freeze({
  ...
  "mcp_discovery": { fields: {
    outcome: enumeration("started", "completed"), attempt: integer(1, 2), duration_ms: duration,
    correction_reason: enumeration("none", "uncovered_outcomes", "tool_limit", "coverage_and_limit"),
    input_bytes: integer(0, MAX_DROPPED), candidate_count: integer(0, MAX_DROPPED),
    selected_count: integer(0, MAX_DROPPED), requirement_count: integer(0, MAX_DROPPED),
    uncovered_count: integer(0, MAX_DROPPED), previous_uncovered_count: integer(0, MAX_DROPPED), selection_changed: bool
  }, level: "info" },
