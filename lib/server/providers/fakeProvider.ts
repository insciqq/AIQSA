...
const WORKSPACE_TEST_DIRECTIVE = /^\[AIQSA_WORKSPACE_E2E:(deterministic_prepare|live_prepare|live_quiesce_probe|long_command|network_off_probe|reset_probe|state_probe)\]$/u;
