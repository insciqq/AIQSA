...
Scope: Non-normative router to bounded authentication, sharing, Control Center, Settings, Assistant, and Knowledge interaction owners.
...
| --- | --- |
| Visual/server ownership boundaries or change rules across account, sharing, administration, Settings, Assistants, and Knowledge | [Boundaries and change rules](account/BOUNDARIES_AND_CHANGE_RULES.md) |
...
| Settings, user MCP tools, Assistants, Knowledge management/publication, focus, appearance, or project settings | [Settings, Assistants, and Knowledge](account/SETTINGS_AND_ASSISTANTS.md) |
