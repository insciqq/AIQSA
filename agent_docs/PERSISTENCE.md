...
Project deletion is an explicit Owner-authorized aggregate transition that removes Project-owned content and bindings under database ownership rules. Deleting an individual account does not substitute for deleting a Project, and Project archival does not rewrite accepted evidence.
