...
| Current-user catalogs/settings, chats, Assistants, messages, branches, runs, tools, recovery/outcome reads, or cancellation | [Catalog, chats, and runs](api/CATALOG_CHATS_AND_RUNS.md) |
