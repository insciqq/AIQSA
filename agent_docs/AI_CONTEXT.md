...
- Fake, native/compatible OpenAI Responses, compatible Chat Completions, Anthropic Messages, and OpenRouter adapters behind database-resolved server-only provider contracts.
