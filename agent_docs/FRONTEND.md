...
- [Composer and controls](frontend/COMPOSER_AND_CONTROLS.md) — routing index for composer, workspace navigation, next-run controls, receipts, and Details.
- [Account, admin, and sharing](frontend/ACCOUNT_ADMIN_AND_SHARING.md) — routing index for auth, public shares, Control Center, Settings, and the Assistants surface.
