...
4. Reading state collapses the Run summary and compact profile/action footer while leaving the bounded `Message` field visible. Activating that field expands the complete controls before the user continues composing.
