...
| Uploads, attachments, object storage, in-process or sidecar extraction, provider discovery, catalogs, or provider-controlled input | [Uploads and provider trust](security/UPLOADS_AND_PROVIDER_TRUST.md) |
