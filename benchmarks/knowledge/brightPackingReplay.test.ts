...
const request: ProviderRunRequest = { provider: "fake", modelId: "fixture", modelCapabilities: { contextWindow: 32768, nativePdfInput: false, nativeSearch: false, pdf: false, reasoning: false, vision: false },
  knowledgeEvidencePackingVersion: 4, attachmentIds: [], attachments: [], chatId: "chat",
  knowledgePlan: { baseIds: ["base"], mode: "explicit", sourceIds: [], version: 1 },
